...
class Mouse:
    ...
    def __init__(self, devices: Sequence[usb_hid.Device]):
        ...
        # report[0] button.py pressed (LEFT, MIDDLE, RIGHT)
        # report[1] x movement
        # report[2] y movement
    ...
    def press(self, buttons: int) -> None:
        """Press the given mouse button.py.
        ...
        Examples::
            ...
            # Press the left and right button.py simultaneously.
    ...
    def release(self, buttons: int) -> None:
        """Release the given mouse button.py.
    ...
    def release_all(self) -> None:
        """Release all the mouse button.py."""
        self.report[0] = 0
        self._send_no_move()

    def click(self, buttons: int) -> None:
        """Press and release the given mouse button.py.
